...
description: 内容创作一站式。图片生成/PPT制作/视频剪辑/语音合成/音乐生成。Use for AI-powered content creation including images, slides, videos, audio.
version: 1.0.0
metadata:
  oneapichat:
    tools: [generate_image, generate_ppt, video_edit, video_understanding, mmx_image, mmx_video, mmx_speech, mmx_music, mmx_chat, mmx_vision]
    priority: medium
    emoji: "🎨"
    triggers: [生成图片, 画图, 做PPT, 视频剪辑, 语音合成, TTS, 配乐, 音乐, AI绘画, AI视频, 幻灯片, 文生图, 图生图, 海报, 插画, 创作, 生成视频, 做视频, 配音, 字幕]
---

# 内容创作一站式

AI驱动的多媒体内容创作: 图片/PPT/视频/音频全链路。
