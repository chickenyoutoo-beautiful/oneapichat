...
if ($method === 'POST' && isset($_GET['action']) && $_GET['action'] === 'save') {
    ...
    $allowedKeys = [
        ...
        // ★ 提供商专用密钥 (前端按 provider 独立存储,第三方 MCP 生图需要)
        'imageModel_minimax', 'imageModel_openrouter', 'imageModel_openai', 'imageModel_custom',
        'imageApiKeyOpenrouter', 'imageBaseUrlOpenrouter',
        'imageApiKeyOpenai', 'imageBaseUrlOpenai',
        'imageApiKeyCustom', 'imageBaseUrlCustom',
        'temp', 'tokens', 'stream',
        ...
        'searchApiKey', 'searchApiKeyBrave', 'searchApiKeyGoogle', 'searchApiKeyTavily', 'searchApiKeyDeepSeek',
